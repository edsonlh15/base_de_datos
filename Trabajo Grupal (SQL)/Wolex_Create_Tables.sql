...
-- Reference: usuario_empresa_proveedora (table: usuario)
ALTER TABLE usuario ADD CONSTRAINT usuario_empresa_proveedora
    FOREIGN KEY (idEmpresaProvedora)
    REFERENCES empresa_provedora (idEmpresaProvedora);

-- Reference: usuario_zona (table: usuario)
ALTER TABLE usuario ADD CONSTRAINT usuario_zona
    FOREIGN KEY (idZona)
    REFERENCES zona (idZona);
